import TybaShowCard2025Img from "@/assets/images/tyba-yacht-charter-show-2025-thumbnail.jpg";
import CalendarIcon from "@/assets/icons/calendar-icon.svg";
import { Link } from "react-router-dom";

export const TybaShowCard = () => {
  return (
    <div className="w-full bg-gray-100 rounded-[5px] max-w-[350px]">
      <Link to="/">
        <img
          src={TybaShowCard2025Img}
