import EastMedShowCard2025Img from "@/assets/images/east-med-multihull-and-yacht-charter-show-emmys-2025-thumbnail.jpg";
import CalendarIcon from "@/assets/icons/calendar-icon.svg";
import { Link } from "react-router-dom";

export const EastMedShowCard = () => {
  return (
    <div className="w-full bg-gray-100 rounded-[5px] max-w-[350px]">
      <Link to="/">
        <img
          src={EastMedShowCard2025Img}
        ...
        <div className="flex justify-between pt-1 pl-2">
          <h4 className="text-secondary font-[Unna-Italic] text-[20px] xl:text-[24px]">
            East Multihull & Yacht Show 2025
          </h4>
        </div>
      </Link>
