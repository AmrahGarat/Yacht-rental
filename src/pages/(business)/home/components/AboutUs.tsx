...
export const AboutUs = () => {
  ...
  return (
    <div className="container lg:flex lg:gap-14 justify-between py-[50px] lg:py-[120px]">
      <div className="lg:max-w-[500px] text-white">
        ...
        <p className="text-[12px] lg:text-[16px] leading-[160%] mb-5">
          {t("aboutus.description")}
        </p>
      </div>
      <div className="lg:max-w-[470px] flex flex-wrap justify-between items-center pt-4 lg:pt-0 grayscale-container cursor-pointer bg-white rounded-[20px] bg-opacity-50 gap-4 p-4 z-20">
        <Link to="https://awards.classicboat.co.uk/winners/">
          <img
            src={Award1Img}
            alt="award1img"
            className="h-[50px] sm:h-[110px]"
          />
        </Link>
        ...
        <Link to="https://www.mby.com/motor-boat-awards/2025-motor-boat-awards-winners-best-motorboats-of-the-year-revealed-134060">
          <img
            src={Award5Img}
            alt="award5img"
            className="h-[50px] sm:h-[100px] w-[50px] sm:w-[100px] object-cover"
          />
        </Link>
