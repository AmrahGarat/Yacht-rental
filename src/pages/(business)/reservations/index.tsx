      ...
      <div className="flex items-end justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xs text-muted-foreground mt-1 max-w-[360px] overflow-hidden overflow-ellipsis line-clamp-3">
              {rent.description}
            </p>
          </div>
        </div>
...
const WriteReview = ({
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: () => {
      toast.success("Review submitted successfully. It will be published soon");
      queryClient.invalidateQueries({
        queryKey: [QUERY_KEYS.RESERVATIONS],
      });
    },
