...
import rentService from "@/services/rents/index";
...
const getFormSchema = (isEdit: boolean) =>
  z.object({
    ...
    crew: z.number().positive(),
    cabins: z.number().positive(),
    showInFeatured: z.boolean(),
    images: isEdit
      ? z.any().optional()
      : z
...
const ActionForm = ({ type }: Props) => {
  ...
  useEffect(() => {
    if (editItem) {
      ...
      form.setValue("location", editItem.location._id);
      form.setValue("capacity", editItem.capacity);
      form.setValue("size", editItem.size);
      form.setValue("crew", editItem.crew);
      form.setValue("cabins", editItem.cabins);
      form.setValue("showInFeatured", editItem.showInFeatured);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Name of Yacht" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Yacht Description</FormLabel>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md p-4 mt-5">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      Show this yacht in Featured section
                    </FormDescription>
                  </div>
                </FormItem>
              )}
          ...
          <div className="flex justify-end mt-4">
            <Button asChild variant="secondary">
              <Link to="/dashboard/rents" className="mr-2 text-white">
                Back
              </Link>
            </Button>
