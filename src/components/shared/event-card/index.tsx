import MonacoGrandPrix2025Img from "@/assets/images/monaco-grand-prix-2025-thumbnail.jpg";
...
export const EventsCard = () => {
  return (
    <div className="w-full bg-white rounded-[5px] max-w-[350px]">
      ...
      <p className="text-[#9499A6] text-sm leading-[160%] pt-1">
        Monte Carlo, Monaco
      </p>
    </div>
  );
